    ...
    <div class="panel admin-panel">
        ...
        <div class="padding border-bottom">
            <ul class="search" style="padding-left:10px;">
                <li> <a class="button border-main icon-plus-square-o" href="<?php echo U('add');?>"> 添加品牌介绍</a></li>
                <li>搜索：</li>
                <li>
        ...
        <table class="table table-hover text-center">
            ...
            <?php if(is_array($data)): foreach($data as $key=>$value): ?><tr>
                    ...
                    <td width="10%"><img src="/<?php echo ($value["image"]); ?>" alt="品牌介绍图片" width="70" height="50" /></td>
                    <td><?php echo mb_substr(strip_tags($value['content']),0,30,'utf-8');?>.....</td>
                    <td>
                        <div class="button-group">
                            <a class="button border-main" href="<?php echo U('edit',['id'=>$value['id']]);?>"><span class="icon-edit"></span> 修改</a>
                            <a class="button border-red" href="javascript:void(0)" onclick="return intdel(<?php echo ($value['id']); ?>)"><span class="icon-trash-o"></span> 删除</a>
                        </div>
                    </td>
