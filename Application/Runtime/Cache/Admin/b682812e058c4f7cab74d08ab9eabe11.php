  ...
  <div class="panel admin-panel">
    ...
    <table class="table table-hover text-center">
      <tr>
        ...
        <?php if(is_array($user)): foreach($user as $key=>$value): ?><tr>
          ...
          <div class="button-group"> 
            ...
            <a class="button border-red" href="javascript:void(0)" onclick="return admindel(<?php echo ($value['id']); ?>)"><span class="icon-trash-o"></span> 删除</a>
          </div></td>
