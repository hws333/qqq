...
<div class="news-center">
    <div class="container">
        ...
        <div class="title">
            ...
            <h4>NEW  CENTER</h4>
            <p>
                当前位置 : <a href="/">首页</a>><a href="{U('index')}">新闻中心</a>>新闻详情
                <span>阅读量：66666</span>
            </p>
        </div>
        <div class="contenr">
            <h3><?php echo ($details["news_title"]); ?></h3>
            <div class="text">
                <p><?php echo ($details["content_one"]); ?></p>
            </div>
            <div class="pic">
                <ul>
                    <?php if(is_array($details["news_pic"])): foreach($details["news_pic"] as $key=>$p): ?><li><img src="/<?php echo ($p["photo"]); ?>" alt="4-news-center-1.jpg"/></li><?php endforeach; endif; ?>
                </ul>
            </div>
            <div class="text">
                <?php echo ($details["content_two"]); ?>
            </div>
            <ul class="page">
                <li><a href="<?php echo U('details',['id'=>$up['id']]);?>" <?php if(($maxup['id']) == $_GET['id']): ?>style="display:none;"<?php endif; ?>>上一篇：<?php echo ($up["news_title"]); ?></a></li>
                <li><a href="<?php echo U('details',['id'=>$down['id']]);?>" <?php if(($maxdown['id']) == $_GET['id']): ?>style="display:none;"<?php endif; ?>>下一篇：<?php echo ($down["news_title"]); ?></a></li>
            </ul>
        </div>
        <!--title-end-->
