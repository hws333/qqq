...
<div class="news">
    <div class="container">
        ...
        <div class="title">
            ...
            <h4>NEW  CENTER</h4>
            <p>
                当前位置 : <a href="<?php echo U('Index/index');?>">首页</a>>新闻中心
                <span>阅读量：66666</span>
            </p>
        </div>
        <!--title-end-->
        <div class="content">
            <ul>
                <?php if(is_array($news)): foreach($news as $key=>$v): ?><li>
                    <div class="pic">
                        <a href="<?php echo U('details',['id'=>$v['id']]);?>"><img src="/<?php echo ($v["image"]); ?>" alt="3-news-1.jpg" /></a>
                    </div>
                    <div class="text">
                        <h4><a href="<?php echo U('details',['id'=>$v['id']]);?>"><?php echo ($v["news_title"]); ?></a></h4>
                        <p class="text-detail"><a href="<?php echo U('details',['id'=>$v['id']]);?>"><?php echo mb_substr(strip_tags($v['content_one']),0,30,'utf-8');?>.....</a></p>
                        <p>
                            <a class="more" href="<?php echo U('details',['id'=>$v['id']]);?>">查看更多</a>
